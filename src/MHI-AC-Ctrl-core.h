...
enum ACStatus { // Status enum
  status_rssi = type_status, status_mqtt_lost, status_wifi_lost, status_connected, status_cmd, status_tds1820, status_tsht21, status_hsht21, status_tsht21_troom, status_fsck, status_fmosi, status_fmiso, status_power, status_mode, status_fan, status_vanes, status_troom, status_tsetpoint, status_errorcode, status_wifi_ssid, status_wifi_ip, status_wifi_bssid,
...
class MHI_AC_Ctrl_Core {
  ...
  public:
    ...
    byte get_outdoor() { return op_outdoor_old; };
};
